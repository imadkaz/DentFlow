...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen pt-20 flex items-center justify-center px-6 bg-gradient-to-b from-blue-50 to-white">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-200">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl font-medium hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-200"
            >
              Sign In
            </button>
          </form>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="px-4 py-3 bg-white border-2 border-gray-300 rounded-xl hover:bg-gray-50 transition-all flex items-center justify-center gap-2">
        ...
        <p className="text-center mt-6 text-gray-600">
          ...
          <a href="/get-started" className="text-blue-600 font-medium hover:text-blue-700">
            Start free trial
          </a>
        </p>
      </div>
